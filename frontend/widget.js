(function () {
  ...
  function injectStyles() {
    var css = [
      ...
      '.ecp-quick-replies{padding:8px 16px 0;display:flex;flex-wrap:wrap;gap:6px;}',
      '.ecp-qr-btn{background:' + ECP_CONFIG.primaryColor + ' !important;color:white !important;border:none !important;border-radius:20px !important;padding:8px 14px !important;font-size:13px !important;cursor:pointer !important;transition:all .15s;white-space:nowrap;font-family:inherit !important;line-height:1.3 !important;box-shadow:none !important;}',
      '.ecp-qr-btn:hover{background:' + ECP_CONFIG.accentColor + ' !important;color:white !important;}',
