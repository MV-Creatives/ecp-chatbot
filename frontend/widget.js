(function () {
  ...
  function injectStyles() {
    var css = [
      ...
      '.ecp-qr-btn{background:white;color:' + ECP_CONFIG.primaryColor + ';border:1.5px solid ' + ECP_CONFIG.primaryColor + ';border-radius:20px;padding:5px 12px;font-size:12px;cursor:pointer;transition:all .15s;white-space:nowrap;}',
      '.ecp-qr-btn:hover{background:' + ECP_CONFIG.primaryColor + ';color:white;}',
