(function () {
  ...
  function injectStyles() {
    var css = [
      ...
      'html body .ecp-quick-replies{padding:8px 16px 0;display:flex;flex-wrap:wrap;gap:6px;}',
      'html body .ecp-qr-btn,html body .ecp-qr-btn:link,html body .ecp-qr-btn:visited{background:' + ECP_CONFIG.primaryColor + ' !important;color:white !important;border:none !important;outline:none !important;border-radius:20px !important;padding:8px 14px !important;font-size:13px !important;cursor:pointer !important;transition:background .15s !important;white-space:nowrap !important;font-family:inherit !important;line-height:1.3 !important;box-shadow:none !important;text-decoration:none !important;display:inline-block !important;}',
      'html body .ecp-qr-btn:hover,html body .ecp-qr-btn:active{background:' + ECP_CONFIG.accentColor + ' !important;color:white !important;}',
      ...
      '#ecp-send-btn svg{width:18px;height:18px;fill:white;}',
